...
Okay So what does our project even do? Here’s a [link](https://sharp-borg-ed125d.netlify.app) to it. Here’s the ol’ [GitHub repository](https://github.com/HACC2020/Crewmates) and the [DevPost page](https://devpost.com/software/crewmates?ref_content=user-portfolio&ref_feature=in_progress).
